...
class RacesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create race" do
    assert_difference("Race.count") do
      post races_url, params: { race: { ends_at: @race.ends_at, location: @race.location, name: @race.name, starts_at: @race.starts_at } }
    end
  ...
  test "should update race" do
    patch race_url(@race), params: { race: { ends_at: @race.ends_at, location: @race.location, name: @race.name, starts_at: @race.starts_at } }
